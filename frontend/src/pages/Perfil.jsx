...
import { Bell, Cable, CalendarDays, Check, HeartPulse, IdCard, Info, LogOut, Mail, Maximize2, Phone, Settings, Smile, UserRound } from 'lucide-react';
        ...
        <section aria-labelledby="configuracoes">
          ...
          <TopicList
            itens={[
              ...
              { icone: Cable, titulo: 'Conexões', descricao: 'Relógios, anéis e dispositivos de saúde.', to: '/conexoes' },
