...
export default function SecurityNote({ className = '' }) {
  return (
    <div className={`flex items-center gap-3 rounded-2xl bg-superficie/50 px-4 py-3 ring-1 ring-borda/70 ${className}`}>
      <ShieldCheck size={22} className="shrink-0 text-acento" aria-hidden="true" />
